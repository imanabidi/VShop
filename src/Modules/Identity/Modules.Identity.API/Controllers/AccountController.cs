    ...
    : ApplicationControllerBase
{
    ...
    private readonly IIdentityContext _identityContext = context.Identity;
    ...
    {
        Result result = await commandDispatcher.SendAsync(command);
    ...
    {
        Result<SignInInfo> result = await commandDispatcher.SendAsync(command);
    ...
    {
        Result result = await commandDispatcher.SendAsync(new SignOutCommand());
        return HandleResult(result, NoContent);
    }
    ...
    {
        Result result = await commandDispatcher.SendAsync(command with{ UserId = userId });
        return HandleResult(result, NoContent);
    }
    ...
    public async Task<IActionResult> GetUserAsync([FromRoute] Guid userId)
    {
        ...
        Result<User> result = await queryDispatcher.QueryAsync(query);
