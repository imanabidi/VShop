...
public static class ModuleLoader
{
    ...
    private static IList<Assembly> LoadAssemblies(IConfiguration configuration)
    {
        ...
        List<string> files = Directory.GetFiles(AppDomain.CurrentDomain.BaseDirectory, "*.dll")
            ...
            .Where(IsLoadableModuleAssembly)
            .ToList();
    ...
    private static bool IsLoadableModuleAssembly(string file)
        => Path.GetFileName(file).StartsWith(Module.Prefix, StringComparison.InvariantCultureIgnoreCase);
}
